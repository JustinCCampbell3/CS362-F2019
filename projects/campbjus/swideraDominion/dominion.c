...
//prototypes for 5 functions implemented for assignment 2
int playBaron(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus);
int playMinion(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus);
int playAmbassador(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
		playMine(card, choice1, choice2, choice3, state, handPos, bonus);
        return 0;
    ...
    case baron:
		playBaron(card, choice1, choice2, choice3, state, handPos, bonus);
        return 0;
    ...
    case tribute:
		playTribute(card, choice1, choice2, choice3, state, handPos, bonus);
        return 0;

    case ambassador:
		playAmbassador(card, choice1, choice2, choice3, state, handPos, bonus);
        return 0;
...
//start of my code (Alex Swider) altering 5 cards: 1) baron, 2) minion, 3) ambassador, 4) tribute, and 5) mine
//
//
//
//
//
//
//the functions implemented will have bugs placed within them as part of the assignment, and the bugs will be noted in the PDF
	...
	if ((state->discardCount[nextPlayer] + state->deckCount[nextPlayer]) <= 1) {
		...
		for (i = 0; i <= 2; i ++) {
			if (tributeRevealedCards[i] == copper || tributeRevealedCards[i] == silver || tributeRevealedCards[i] == gold) { //Treasure cards
				...
				state->coins = state->numActions + 2;
			}
		}
